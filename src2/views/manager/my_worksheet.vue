    ...
    <el-table :data="showTableData" stripe style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="170">
        <template slot-scope="scope">
          ...
          <a-button type="primary" style="height: 30px;line-width: 50px;line-height: 30px;display: inline;margin-left: 10px;" @click="showDrawer"> 处理 </a-button>
  ...
  methods: {
    ...
    getAllData() {
      this.axios({
        ...
        headers: {
          Authorization:
            "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzM4NCJ9.eyJpZCI6IjJmODMxYmIzLTYwNDktNDYwNy05Y2YzLTMxMGM0YmQyMjY0YSIsImV4cCI6MTYwNzI2NTkxMH0.41sbf0a68xiKZ3GZajv1UjyunraEts_BMB_bIGCLVgyHH1_cYBjXkwXZk-wRbJUa",
        },
      }).then((res) => {
        //超出限制用... 和 修改日期
